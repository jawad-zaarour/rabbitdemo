package com.alpha.rabbitmqdemo.config;

import com.alpha.rabbitmqdemo.service.ConsumerService;
...
import static com.alpha.rabbitmqdemo.invariant.RabbitConstants.*;
